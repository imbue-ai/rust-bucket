<!-- Generated by rust-bucket v0.6.4. DO NOT EDIT BY HAND. -->

# Style Guide

Every decision in this guide serves three principles: **minimalism**, **professionalism**, and **maintainability**. Write the least code that solves the problem correctly, keep it readable to a stranger six months from now, and leave the codebase easier to change than you found it. When a rule below is ambiguous, resolve it in favour of these principles.
...
## Comments
- Do not use comment banners (`// === section === //`, `// ----------`, or similar decorative separators). Let module structure and naming convey organization.
- Default to writing no comments. Only add one when the reason behind the code is non-obvious.
