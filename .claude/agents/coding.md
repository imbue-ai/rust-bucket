...
- **Do NOT run `br close`, `br update <id> --status ...`, or otherwise mutate bead status.** Closing the bead is the Coordinator's job, executed only after the Judge passes.
